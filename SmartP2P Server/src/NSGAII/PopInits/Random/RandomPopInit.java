...
package NSGAII.PopInits.Random;

import java.util.Random;
import java.util.ArrayList;

public class RandomPopInit implements NSGAII.PopInits.PopInit {
    ...
    public RandomPopInit(NSGAII.Algorithm alg) {
    ...
    public void initialize(){
       ...
       //Adding for each parent its children until a child alreasy has a parent
           ...
           NSGAII.Solutions.Solution oneSolution = new NSGAII.Solutions.QRTPSolution.OneSolution(chromosomeSize);
     ...
     public NSGAII.Solutions.Solution[] getPopIP(){
