...
public class DBConnector{
	...
	private String connectionUrl = "jdbc:sqlserver://natalie-pc\\sqlexpress;databaseName=GEOLIFE;user=sa;password=ancon79;";
	...
	public int[][] getNumberOfPapers(String filter){
		...
		try {
			...
			while (rs.next()) {
				...
				/*System.out.println(rs.getInt("JAVA_ID") + "\t"
