...
package NSGAII.Problems;

import java.util.*;

import MOEAD.SQLServer.DBConnector;
...
public class QueryRoutingTreeProblem {
    ...
    //blueTooth_Uplink data rate up to 120 kbps
    double blueTooth_Uplink = 120000.0;
    //threeG_Uplink 384kbps
    double threeG_Uplink = 64000.0;
    double relevant = 1.0;
    ...
    public QueryRoutingTreeProblem(NSGAII.Algorithm alg) {
    ...
    public void readDatabase(int id, String word){
                ...
                DBConnector obj = new  MOEAD.SQLServer.DBConnector("127.0.0.1", 1433, "SMARTP2P");
    ...
    public NSGAII.Solutions.Solution evaluateSolution(NSGAII.Solutions.Solution currentSolution){
