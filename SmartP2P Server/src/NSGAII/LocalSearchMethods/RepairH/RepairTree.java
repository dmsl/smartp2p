...
package NSGAII.LocalSearchMethods.RepairH;
...
public class RepairTree {
    ...
    public RepairTree(NSGAII.Solutions.Solution mutatedOffspring) {
    
        this.mutatedOffspring = mutatedOffspring;   
    }
    
    
    public NSGAII.Solutions.Solution repair(){
    
        int[] mutatedChromosome = mutatedOffspring.getChromosome();
        
        NSGAII.Solutions.Solution repairedOffspring = new NSGAII.Solutions.QRTPSolution.OneSolution(mutatedChromosome.length);
