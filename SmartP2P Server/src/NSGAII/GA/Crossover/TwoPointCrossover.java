...
public class TwoPointCrossover {
     ...
     */
    public TwoPointCrossover(ArrayList selectedParents, NSGAII.Algorithm alg) {
    ...
    public NSGAII.Solutions.Solution recombine(){
    
        NSGAII.Solutions.Solution offspring1 = new NSGAII.Solutions.QRTPSolution.OneSolution(alg.chromosomeSize);
        int[] cromosomeOffspring1 = new int[alg.chromosomeSize];
        
        NSGAII.Solutions.Solution offspring2 = new NSGAII.Solutions.QRTPSolution.OneSolution(alg.chromosomeSize);
        int[] cromosomeOffspring2 = new int[alg.chromosomeSize];
        
        NSGAII.Solutions.Solution parent1 = (NSGAII.Solutions.Solution)selectedParents.get(0);
        int[] cromosomeParent1 = parent1.getChromosome();
        
        NSGAII.Solutions.Solution parent2 = (NSGAII.Solutions.Solution)selectedParents.get(1);
