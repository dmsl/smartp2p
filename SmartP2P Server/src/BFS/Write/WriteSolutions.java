...
public class WriteSolutions {
    ...
    protected BFS.BFSAlg alg = null;
    BFS.Solutions.Solution solution;
    String link = "";

    
    /** Creates a new instance of WriteSolutions */
    public WriteSolutions(BFS.BFSAlg alg, BFS.Solutions.Solution solution) {
    ...
    public void writeNondDomSolutions(){
     ...
     try {
            ...
            BufferedWriter out1 = new BufferedWriter(new FileWriter(spoonFeeding+"outBests1.log",true));
                    ...
                    out.write(" "+String.valueOf(((BFS.Solutions.Solution) solution).getEnergy()));
                    out.write(" "+String.valueOf(((BFS.Solutions.Solution) solution).getTime()));
                    out.write(" "+String.valueOf(((BFS.Solutions.Solution) solution).getRecall()));
                    
                    //The same but without the solution number for Smetric
                    out1.write(" "+String.valueOf(((BFS.Solutions.Solution)solution).getEnergy()));
                    out1.write(" "+String.valueOf(((BFS.Solutions.Solution) solution).getTime()));
                    out1.write(" "+String.valueOf(-((BFS.Solutions.Solution)solution).getRecall()));
    ...
    public void writeTree(){
       ...
       String newFolderName1 = "/PFtrees/";
        ...
        BufferedWriter out = new BufferedWriter(new FileWriter(spoonFeeding+"PFtree"+0+".log",true));            
                    int[] testTree = (int[])((BFS.Solutions.Solution)solution).getChromosome();
