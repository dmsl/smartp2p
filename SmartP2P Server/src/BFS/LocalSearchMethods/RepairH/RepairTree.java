...
package BFS.LocalSearchMethods.RepairH;
...
public class RepairTree {
    ...
    BFS.Solutions.Solution mutatedOffspring;
    Random randomGen = new Random(System.currentTimeMillis());

    
    /** Creates a new instance of RepairTree */
    public RepairTree(BFS.Solutions.Solution mutatedOffspring) {
    
        this.mutatedOffspring = mutatedOffspring;   
    }
    
    
    public BFS.Solutions.Solution repair(){
    
        int[] mutatedChromosome = mutatedOffspring.getChromosome();
        
        BFS.Solutions.Solution repairedOffspring = new BFS.Solutions.QRTPSolution.OneSolution(mutatedChromosome.length);
