...
package MOEAD.LocalSearchMethods.RepairH;
...
public class RepairTree {
    ...
    MOEAD.Solutions.Solution mutatedOffspring;
    Random randomGen = new Random(System.currentTimeMillis());

    
    /** Creates a new instance of RepairTree */
    public RepairTree(MOEAD.Solutions.Solution mutatedOffspring) {
    
        this.mutatedOffspring = mutatedOffspring;   
    }
    
    
    public MOEAD.Solutions.Solution repair(){
    
        int[] mutatedChromosome = mutatedOffspring.getChromosome();
        
        MOEAD.Solutions.Solution repairedOffspring = new MOEAD.Solutions.QRTPSolution.OneSolution(mutatedChromosome.length);
