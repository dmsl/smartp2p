...
public class WriteSolutions {
    ...
    public WriteSolutions(MOEAD.Algorithm alg, ArrayList frontToPrintEP) {
    ...
    public void writeNondDomSolutions(){
     ...
     try {
           ...
           int i = 0 ; 
              ...
              if ((((MOEAD.Solutions.Solution) temp.get(j)).getEnergy()) != 0.0 &&
                 ((((MOEAD.Solutions.Solution) temp.get(j)).getTime())) != 0.0 &&
                 ((((MOEAD.Solutions.Solution) temp.get(j)).getRecall())) != 0.0){
                    
                    out.write(String.valueOf(j+1));
                    out.write(" "+String.valueOf(((MOEAD.Solutions.Solution) temp.get(j)).getEnergy()));
                    out.write(" "+String.valueOf(((MOEAD.Solutions.Solution) temp.get(j)).getTime()));
                    out.write(" "+String.valueOf(((MOEAD.Solutions.Solution) temp.get(j)).getRecall()));
                    
                    //The same but without the solution number for Smetric
                    out1.write(" "+String.valueOf(((MOEAD.Solutions.Solution) temp.get(j)).getEnergy()));
                    out1.write(" "+String.valueOf(((MOEAD.Solutions.Solution) temp.get(j)).getTime()));
                    out1.write(" "+String.valueOf(-((MOEAD.Solutions.Solution) temp.get(j)).getRecall()));
        ...
        f.mkdir();        
             ...
             ArrayList temp = frontToPrintEP;
                ...
                for (int i = 0 ; i < temp.size()  ; i++ ){
                    ...
                    int[] testTree = (int[])((MOEAD.Solutions.Solution)temp.get(i)).getChromosome();
