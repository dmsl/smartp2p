...
public class RandomSelection{
    ...
    public RandomSelection(MOEAD.Solutions.Solution[] currentPopIPforGA, int currentSubproblem) {
    ...
    public ArrayList select(){
        ...
        parents.add((MOEAD.Solutions.Solution)currentPopIPforGA[parent1Number]);
        parents.add((MOEAD.Solutions.Solution)currentPopIPforGA[parent2Number]);        
        return parents;    
    }
