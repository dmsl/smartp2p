...
public class SwapMutation {
    ...
    MOEAD.Solutions.Solution offspring;
    protected  MOEAD.Algorithm alg;
    Random randomGen = new Random(System.currentTimeMillis());
    double mutationRate = 0.0;
    
    /** Creates a new instance of SwapMutation */
    public SwapMutation(MOEAD.Solutions.Solution offspring, MOEAD.Algorithm alg, double mutationRate) {
    ...
    public MOEAD.Solutions.Solution mutate(){
