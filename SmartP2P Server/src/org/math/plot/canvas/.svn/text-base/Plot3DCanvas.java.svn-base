...
public class Plot3DCanvas extends PlotCanvas {
        ...
        public AWTDrawer3D getDraw() {
        	return (AWTDrawer3D) this.draw;
        }
        ...
        public void mouseDragged(MouseEvent e) {
                ...
                case TRANSLATION:
                        ...
                        break;
                case ZOOM:
                		System.out.println("mouseCurrent[0] = " + mouseCurent[0] + " mouseClick[0] = " + mouseClick[0] + " mouseCurent[1] = " + mouseCurent[1] + " mouseClick[1] = " + mouseClick[1]);
                        repaint();
