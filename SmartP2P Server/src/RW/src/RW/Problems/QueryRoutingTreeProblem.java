...
public class QueryRoutingTreeProblem {
    ...
    public QueryRoutingTreeProblem( RW.src.RW.RWAlg alg) {
    ...
    public void readDatabase(int id, String word){
		...
		chromosomeSize = obj.getCountUsers();		
		distance_list = new double[chromosomeSize][chromosomeSize];
		...
		file_list = obj.getNumberOfPapers(word, id);
                ...
                System.out.println("Active Users: "+ chromosomeSize);
    }
    
    public RW.src.RW.Solutions.Solution evaluateSolution(RW.src.RW.Solutions.Solution currentSolution){
